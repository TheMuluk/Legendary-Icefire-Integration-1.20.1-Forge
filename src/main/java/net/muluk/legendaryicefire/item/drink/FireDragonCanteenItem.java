...
public class FireDragonCanteenItem extends CanteenItem {

    public FireDragonCanteenItem(Properties properties) {
        super(properties);
    }
    ...
    public @NotNull String getDescriptionId(ItemStack stack) {
        if(ThirstUtil.getCapacityTag(stack) == 0)
            return "item."+ LegendaryIcefireIntegrationMod.MOD_ID+"."+"fire_dragon_canteen_empty";

        if (ThirstUtil.getHydrationEnumTag(stack) == HydrationEnum.PURIFIED)
            return "item."+ LegendaryIcefireIntegrationMod.MOD_ID+"."+"fire_dragon_canteen_purified";
        else
            return "item."+ LegendaryIcefireIntegrationMod.MOD_ID+"."+"fire_dragon_canteen";
    }
